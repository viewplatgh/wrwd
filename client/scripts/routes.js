define(function(require) {
  ...
  var wrwdInit = function () {
      ...
      // var jquery_layout = require('jquery_layout');
      // var jstree = require('jstree');
      // var ace = require('ace');
      // var can = require('can');
      // var co = require('can/util/object');
      // var sptf = require('sprintf');
      // var getopt = require('getopt');
      // var wrwd = require('wrwd');
         var $ = window.jQuery;
         var jquery_ui = $.ui;
         var jquery_layout = $.layout;
         var jstree = $.jstree;
         var ace = window.ace;
         var can = window.can;
         var co = can.Object;
         var sptf = window.sprintf;
         // var getopt = require('getopt');
         var wrwd = window.createWrwd();
        ...
        (function ($, jquery_ui, jquery_layout, jstree, ace, can, co, sptf, wrwd) {
          ...
          */
          var layoutSettings = {
            ...
            var westSelector = ".main-container .content > .ui-layout-west"; // outer-west pane
            ...
            */
            ...
            //var wly = $("body").layout(layoutSettings);
            // // save selector strings to vars so we don't have to repeat it
        ...
        })($, jquery_ui, jquery_layout, jstree, ace, can, co, sptf, wrwd);
