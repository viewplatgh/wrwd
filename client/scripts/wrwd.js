...
"use strict";
(function (window) {
    window.createWrwd = function (){
        var wrwd = ({});
        var $ = window.jQuery;
        var ace = window.ace;
        var can = window.can;
        var canList = can.List;
        var canMap = can.Map;
        var canObject = can.Object;
        var basicParser = window.basicParser;
        ...
        wrwd.output = function (text) {
                            ...
                            line.html(text);
                            var out = $("#main-content > .ui-layout-center > .ui-layout-content");
                            out.append(line);
